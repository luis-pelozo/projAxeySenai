...
<body>
    ...
    <div class="container">
        ...
        <div class="row d-flex flex-wrap ">
            ...
            <!-- Avaliações  -->
            <div class="col-sm-4 mb-3 mb-sm-0 mt-2 right d-flex flex-wrap">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card" style="width:100% ; align-items:start ; margin:0">
                            <div class="card-body" style="padding: 0;">
                                <h6 class="card-subtitle mb-2 text-muted">
                                    <img src="" alt="Ícone-Usuaruo" class="mb-3" style="background-color: #0711FF; border: none; width: 25%">Usuario 69<img src="" alt="Ícone-Avl" class="mb-3" style="background-color: #0711FF; border: none; width: 25%">
                                </h6>
