...
<body>
    ...
    <section class="avaliacao container-fluid py-4">
        <h1 class="text-center">Avaliação</h1>
        <div class="imagem container">
            <img src="../../assets/img/icones_usuario/854888-200.png" alt="Ícone de usuário">
        </div>
        <div class="container">
            <form action="index.php" method="post">
                ...
                <div class="row mb-3 py-5">
                    ...
                    <textarea class="form-control" id="nome" name="nome" placeholder="Digite seu nome" required></textarea>
                </div>
                <div class="row mb-3 py-5">
